...
import { downloadDocumentById, generateOrganizationUploadUrl, generatePersonalUploadUrl, saveOrganizationDocument, savePersonalDocument } from "../controller/docs.controller";

const router = Router();

router.get('/personal/:id', authMiddleware, downloadDocumentById)
router.get('/organization/:id', authMiddleware, downloadDocumentById)
